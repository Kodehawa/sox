...
import sox.command.argument.split.SplitString;
...
public class Arguments implements Iterator<SplitString> {
    ...
    /**
     * Marks the current offset, for jumping back at a later point. Only one index can be marked at once,
     * with future mark calls overriding it.
     *
    ...
    /**
     * Jumps back to the currently marked offset. If mark hasn't been called yet, jumps back to offset 0.
     *
     * @apiNote This method should be avoided by parsers. Use the {@link #marked() marker} API instead.
     */
    public void reset() {
